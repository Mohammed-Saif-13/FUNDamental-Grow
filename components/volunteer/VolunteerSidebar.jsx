...
export default function VolunteerSidebar({ isOpen, onClose }) {
    ...
    return (
        <>
            ...
            <aside
                className={cn(
                    "fixed top-0 left-0 h-full bg-slate-800 text-white z-50 transition-all duration-300",
                    collapsed ? "w-20" : "w-64",
            ...
            >
                ...
                <div className="flex items-center gap-3 p-4 border-b border-slate-700">
                    <div className="h-10 w-10 bg-purple-500 rounded-xl flex items-center justify-center flex-shrink-0">
                        <Heart className="h-6 w-6 text-white" />
                    </div>
                    {!collapsed && (
                        <div className="overflow-hidden">
                            <h1 className="font-bold text-lg">FUNDamental</h1>
                            <p className="text-xs text-slate-400">Volunteer Panel</p>
                        </div>
                    )}
